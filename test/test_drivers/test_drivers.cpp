...
void test_light_sensor_adc_to_lux_conversion(void) {
    ...
    // 3093 ADC -> ~500 lx (Dark Threshold)
    setMockAnalogRead(35, 3093);
    advanceSimulatedMillis(2001);
    SensorData d500 = lightSensor.read();
    TEST_ASSERT_FALSE(d500.isError);
    TEST_ASSERT_FLOAT_WITHIN(30.0f, 500.0f, d500.value);

    // 3938 ADC -> ~10000 lx (Critical Daylight)
